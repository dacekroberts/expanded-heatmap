...
|---|---|---|
| 🟢 **A** | **Ready to build.** Register measured, licence read, coordinates answered, rail answered — every remaining question is answerable inside the build | **14** *(+ 16 built)* |
...
## 🟢 Band A — ready to build (14 ready + 16 ✅ BUILT)

**The fourteen:** Seoul · Hong Kong — **each with a brief** in `docs/build_briefs/` — **nine
...
| **Total** | **30** | **31** | | *(+ 11 in the open gap)* |
