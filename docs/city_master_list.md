...
## 🟢 Band A — ready to build (21 ready + 16 ✅ BUILT)

**The twenty-one:** Seoul · Hong Kong — **each with a brief** in `docs/build_briefs/` — **nine
