...
|---|---|---|
| 🟢 **A** | **Ready to build.** Register measured, licence read, coordinates answered, rail answered — every remaining question is answerable inside the build | **11** *(+ 26 built)* |
...
## 🟢 Band A — ready to build (11 ready + 26 ✅ BUILT)
...
Osaka · Kobe · Sapporo · Fukuoka (4/4 each) · Kyoto (8/8), and ~~Rotterdam~~ ✅ **built 2026-09-24**. ✅ **Every Band A city has a brief**, and
...
| 🇰🇷 South Korea | — | **1** — Seoul | A | Build. Step 0 complete 2026-09-24; four owner calls open (`seoul.md`) |
...
| 🇰🇷 **South Korea** | **1** — Seoul | 17 datasets, EPSG:5174, KOGL Type 1, daily | **Build items, not probes:** the register's own building points fill restaurants to 97.7%; a Korean-aware `check_personal_exposure.py` (113 premises sized). Four owner calls first (`seoul.md`) |
