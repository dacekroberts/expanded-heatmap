...
| 🇹🇼 Taiwan | **2** | **2** — Taipei (Regional) · Kaohsiung | A · D | **Taichung and Taoyuan built 2026-09-25** (the national modules, the shared step 2, the `taiwan-city` skill). **No geocoder** — a door-plate JOIN at 92.2–95.5%. One city build-ready; **Kaohsiung's address file is geo-blocked to Taiwan** |
