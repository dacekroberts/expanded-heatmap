...
|---|---|---|
| 🟢 **A** | **Ready to build.** Register measured, licence read, coordinates answered, rail answered — every remaining question is answerable inside the build | **17** *(+ 13 built)* |
...
## 🟢 Band A — ready to build (17 ready + 13 ✅ BUILT)

**The seventeen:** Seoul · Prague ▲ · Rome ▲ · Amsterdam ▲ · Hong Kong — **each with a brief** in `docs/build_briefs/` — **nine
