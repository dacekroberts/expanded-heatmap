...
| **Japan** — the candidate cities' permit lists, MHLW's open data, MLIT's address and rail layers (**candidates, not built**) | Mostly **PERMITTED WITH CONDITIONS** (CC BY 4.0, CC BY 2.1 JP, PDL 1.0). Sendai's lists need permission. **Five sources are not yet read.** One source per row in the Japan section below | Per source, below |
...
terms had never been read. They are listed below as unread rather than
borrowed from a neighbour's verdict.
...
**Fault-based cost clauses, the Taiwan question again, now an owner call.**
- **What they say**: several Japanese terms make the user bear the cost of
  ...
  Kong's indemnity.
- **Accepted so far**: the owner accepted **Tokyo §6 / Chūō §5** and
  **Sapporo 第9条3** individually on 2026-09-24.
- **Not yet accepted on their own**: **Fukuoka 第４条**, **Hiroshima 第3条** and
  **MHLW 免責 1) エ**.
- **Taiwan's precedent**: one decision covered every source in the country.
  Whether one decision covers every Japanese source is the owner's call.
