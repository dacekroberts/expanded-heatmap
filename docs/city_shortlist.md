...
| 3 | Los Angeles | Metro Rail (heavy + light), ~110 stations | Listing of Active Businesses (Socrata `6rrh-rzua`, `data.lacity.org`): `naics`, `street_address`, `location_1`; monthly updates | `naics` | Next. Larger rail system - check for the central-plus-offshoot shape |
