...
| `python scripts/check_no_fetch_in_steps.py` | no `pipeline/*/step*.py` reaches the network, **directly or through a shared `pipeline/*.py` module**; and no `KNOWN_GAPS` entry has quietly been fixed and left listed |
