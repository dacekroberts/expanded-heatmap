"""Fortaleza (Regional) step 3: render the heatmap - all rendering in pipeline/map_common.py.

    python pipeline/fortaleza/step3_map.py
"""
import sys
...
from pipeline.fortaleza import config as c  # noqa: E402
from pipeline.fortaleza.boundary import city_polygon  # noqa: E402
