"""Porto Alegre (Regional) step 2: CNEFE 2022 -> the storefronts the census enumerated in the
scope - thin over pipeline/countries/brazil_register.py.

    python pipeline/porto_alegre/step2_clean_businesses.py
"""
import sys
...
from pipeline.porto_alegre import config  # noqa: E402
from pipeline.porto_alegre.boundary import city_polygon  # noqa: E402
