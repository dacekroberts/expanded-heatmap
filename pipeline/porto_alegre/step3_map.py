"""Porto Alegre (Regional) step 3: render the heatmap - all rendering in pipeline/map_common.py.

    python pipeline/porto_alegre/step3_map.py
"""
import sys
...
from pipeline.porto_alegre import config as c  # noqa: E402
