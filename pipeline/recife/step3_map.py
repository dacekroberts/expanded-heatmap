"""Recife (Regional) step 3: render the heatmap - all rendering in pipeline/map_common.py.

    python pipeline/recife/step3_map.py
"""
import sys
...
from pipeline.recife import config as c  # noqa: E402
