"""Salvador step 3: render the heatmap - all rendering in pipeline/map_common.py.

    python pipeline/salvador/step3_map.py
"""
import sys
...
from pipeline.salvador import config as c  # noqa: E402
