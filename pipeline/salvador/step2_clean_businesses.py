"""Salvador step 2: CNEFE 2022 -> the storefronts the census enumerated in the
scope - thin over pipeline/countries/brazil_register.py.

    python pipeline/salvador/step2_clean_businesses.py
"""
import sys
...
from pipeline.salvador import config  # noqa: E402
from pipeline.salvador.boundary import city_polygon  # noqa: E402
