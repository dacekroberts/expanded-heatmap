"""Santos (Regional) step 3: render the heatmap - all rendering in pipeline/map_common.py.

    python pipeline/santos/step3_map.py
"""
import sys
...
from pipeline.santos import config as c  # noqa: E402
from pipeline.santos.boundary import city_polygon  # noqa: E402
