"""Brasília step 3: render the heatmap - all rendering in pipeline/map_common.py.

    python pipeline/brasilia/step3_map.py
"""
import sys
...
from pipeline.brasilia import config as c  # noqa: E402
from pipeline.brasilia.boundary import city_polygon  # noqa: E402
