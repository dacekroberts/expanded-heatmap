...
Madrid-specific. Scaffolded by scripts/scaffold_city.py.

Input:  data/madrid/processed/stations.csv
        data/madrid/processed/businesses_clean.csv
        data/madrid/raw/gtfs.zip                    (for the line overlay)
        data/madrid/raw/city_boundary.geojson       (label anchoring)
...
def main():
    ...
    render_heatmap(
        ...
        map_title="Madrid Metro de Madrid Business Density Heatmap",
        city_name="Madrid",
        system_name="Metro de Madrid",
        stations=pd.read_csv(STATIONS_CSV),
        businesses=pd.read_csv(BUSINESSES_CLEAN_CSV),
        taxonomy_system=TAXONOMY_SYSTEM,
        lines=load_line_shapes(GTFS_ZIP, LINE_SPECS, "Metro de Madrid"),
