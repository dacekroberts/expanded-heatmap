"""Taipei (Regional) heatmap page - embeds the pre-rendered Folium HTML.
...
st.set_page_config(page_title="Taipei (Regional) Heatmap", page_icon="\U0001f5fa️", layout="wide")
set_base_font()
