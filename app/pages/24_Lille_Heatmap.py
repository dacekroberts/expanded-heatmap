...
from pipeline.lille.config import HEATMAP_HTML  # noqa: E402
...
st.title("Lille (Regional): commercial density around Ilevia station areas")
...
`outputs/lille/excluded_stations.csv`), and the data source and its
limitations.
