"""Porto Alegre (Regional) heatmap page - embeds the pre-rendered Folium HTML.
...
st.set_page_config(page_title="Porto Alegre (Regional) Heatmap", page_icon="\U0001f5fa\ufe0f", layout="wide")
set_base_font()
